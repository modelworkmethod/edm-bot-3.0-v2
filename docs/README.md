...
- [Commands](./Commands.md) - Available Discord commands
- [Environment](./Environment.md) - Configuration variables
- [Migrations](./Migrations.md) - Database setup
- [Tensey Bot Integration](./Tensey_Bot_Integration.md) - Separate Tensey challenge bot
...
- Commands: 18 commands registered (see [Commands.md](./Commands.md))
...
- **Tensey Bot** - Separate process for social freedom challenges (see [Tensey_Bot_Integration.md](./Tensey_Bot_Integration.md))
